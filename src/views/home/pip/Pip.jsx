      ...
      <div className="flex absolute bottom-0 right-[5%] items-start">
        {open && (
          <div className="relative translate-y-[40%]">
            <img
              className="w-[235px] sm:w-[190px] md:w-[235px]"
              src="/images/speech-board-0.png"
              alt="Speech Board"
            />
            <div className="absolute font-poppins-regular text-brown left-0 right-0 top-0 bottom-0 h-[53%] w-[80%] m-auto">
              <div className="text-[12px] leading-[1.4]">{datam[index]}</div>
            </div>
          </div>
        )}
        <button className={open ? "" : "mb-2.5 mr-5 md:mb-5 md:mr-10"}>
          {open ? (
            <img
              className="w-[156px] sm:w-[128px] md:w-[156px]"
              src="/images/riki.png"
              alt="Riki"
              onClick={nextIndex}
            />
